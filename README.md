...
1. Specify the URL of the repository hosting Horizon and fetch it as a dependency.
   ```bash
   zig fetch --save=horizon https://github.com/HARMONICOM/horizon/archive/refs/tags/0.0.8.tar.gz
   ```
   or
   ```bash
   zig fetch --save-exact=horizon https://github.com/HARMONICOM/horizon/archive/refs/tags/0.0.8.tar.gz
   ```
